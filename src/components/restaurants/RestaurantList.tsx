      ...
      {filteredRestaurants.length === 0 ? (
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          {filteredRestaurants.map((restaurant) => (
            <Card
              key={restaurant.id}
              className="border-0 shadow-md hover:shadow-lg transition-shadow bg-slate-50 px-3"
            >
              <CardHeader>
                ...
                <div className="space-y-3">
                  ...
                  {restaurant._count && (
                    <div className="flex items-center text-sm text-muted-foreground">
                      ...
                      {t("restaurants.mealTimesCount", {
                        count: restaurant._count.mealTimes,
                      })}
                    </div>
                  )}
                        ...
                        <AlertDialogContent>
                          <AlertDialogHeader>
                            ...
                            <AlertDialogDescription>
                              {restaurant.gateId
                                ? t(
                                    "restaurants.restaurantLinkedToGateDescription"
                                  )
                                : t("restaurants.deleteConfirmDescription", {
                          ...
                          <AlertDialogFooter>
                            ...
                            {restaurant.gateId ? (
                              <>
                                <AlertDialogAction
                                  onClick={() =>
                                    handleUnlinkAndDelete(restaurant.id)
                                  }
