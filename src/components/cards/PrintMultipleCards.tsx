      ...
      <div className="print-container">
        {cards.map((card) => {
          ...
          return (
            <Card
              key={card.id}
              className={`print-card mx-auto bg-gradient-to-br from-blue-300 to-indigo-400 border border-blue-300 shadow-lg print:shadow-none ${
                isArabic ? "rtl" : "ltr"
              }`}
            >
                  ...
                  <div className="bg-white/90 rounded-lg p-3 space-y-2 w-full">
                    ...
                    <div className="grid grid-cols-1 gap-1 text-xs">
                      ...
                      {card.guest.nationality && (
                        <div className="flex justify-between">
                          <span className="text-gray-500 font-medium">
                            {isArabic ? "Nationality:" : "Nationality:"}
                          </span>
                          <span className="text-gray-700 truncate">
                            {card.guest.nationality}
                          </span>
                      ...
                      card.mealTime && (
                        <div className="bg-blue-50/80 rounded-lg p-3 w-full">
                          <div className="flex justify-between items-center">
                            ...
                            <span className="text-xs text-gray-600 font-mono">
                              {card.mealTime.startTime} -{" "}
                              {card.mealTime.endTime}
                            </span>
                          </div>
                        </div>
                      )
